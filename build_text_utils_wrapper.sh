...
g++ -O2 -fPIC -c $(pkg-config --cflags --libs python3) shape.cpp flatten.cpp uniq.cpp create_tags5_without_guesser.cpp create_tags4_without_guesser.cpp krnnt_utils_wrap.cxx
