...
/*-----------------------------------------------
              @(target):= _create_tag4_test.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__create_tag4_test

#else
#  define SWIG_init    init_create_tag4_test

#endif
#define SWIG_name    "_create_tag4_test"
...
SWIGINTERN PyObject *_wrap_create_tags4_without_guesser(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::string,std::allocator< std::string > > arg1 ;
  PyObject * obj0 = 0 ;
  std::vector< std::string,std::allocator< std::string > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:create_tags4_without_guesser",&obj0)) SWIG_fail;
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    int res = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "create_tags4_without_guesser" "', argument " "1"" of type '" "std::vector< std::string,std::allocator< std::string > >""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = create_tags4_without_guesser(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"create_tags4_without_guesser", _wrap_create_tags4_without_guesser, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
