...
/*-----------------------------------------------
              @(target):= _uniq_test.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__uniq_test

#else
#  define SWIG_init    init_uniq_test

#endif
#define SWIG_name    "_uniq_test"
...
SWIGINTERN PyObject *_wrap_uniq(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::string,std::allocator< std::string > > arg1 ;
  PyObject * obj0 = 0 ;
  std::vector< std::string,std::allocator< std::string > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:uniq",&obj0)) SWIG_fail;
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    int res = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "uniq" "', argument " "1"" of type '" "std::vector< std::string,std::allocator< std::string > >""'"); 
    }
    arg1 = *ptr;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"uniq", _wrap_uniq, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
